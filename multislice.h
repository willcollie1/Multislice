/* Header file for program "Multilsice.c" containing deifnitions and function declarations */
...
int i,j,loop1,tilt, height,width,depth,size,wavefunctionsize,fy, tx, ty, fx,unitcellcode,n[2]; 
double a,b,c,v,total,total1,dx,dy,dz,*x,*y,*V,abbfunction,*k_x2,*k_y2,wavelength,sigma,df,aperture,tiltx,tilty,*k,tester,kmax;
...
/* Output file containing width and height to be used by python */
...
/* Where should the multislice loop start? */ 
